...
module.exports = function (app) {
    ...
    // app.route('/api/auth/token').post(users.tokenAuth);
    ...
    // Setting the github oauth routes
    app.route('/api/auth/stripe').get(users.oauthCall('stripe'));
    app.route('/api/auth/stripe/callback').get(users.oauthCallback('stripe'));
};
